...
public class ShooterPivotSubsystem extends SubsystemBase {
    ...
    private void configure() {
        ...
        m_pivotMotor.setSmartCurrentLimit(Constants.SHOOTER_PIVOT.MOTOR_STALL_LIMIT_AMPS,
        ...
        m_pivotPIDController.setSmartMotionMaxVelocity(Constants.SHOOTER_PIVOT.SMART_MOTION_MAX_VEL_RPM, 0);
        m_pivotPIDController.setSmartMotionMinOutputVelocity(Constants.SHOOTER_PIVOT.SMART_MOTION_MIN_VEL_RPM, 0);
        m_pivotPIDController.setSmartMotionMaxAccel(Constants.SHOOTER_PIVOT.SMART_MOTION_MAX_ACC_RPM, 0);
        m_pivotPIDController.setSmartMotionAllowedClosedLoopError(Constants.SHOOTER_PIVOT.SMART_MOTION_ALLOWED_ERROR,
                0);
    }
    ...
    public boolean isPivotAtRotations() {
        return Utility.isWithinTolerance(getPivotRotations(), m_targetRotations,
                Constants.SHOOTER_PIVOT.SMART_MOTION_ALLOWED_ERROR);
    }
