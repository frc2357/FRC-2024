...
public class ManualLineUpClimb extends SequentialCommandGroup {
   ...
   public ManualLineUpClimb(Trigger continueButton) {
      super(
         ...
         new ParallelCommandGroup(
            new ClimberRotatePastRotations(CLIMBER.ROTATE_PAST_VERTICAL_SPEED, CLIMBER.VERTICAL_ROTATIONS),
            new ExtensionArmMoveToRotations(EXTENSION_ARM.HOME_ROTATIONS),
            new DriveAtSpeed(SWERVE.DISTANCE_FROM_STAGE_TO_CHAIN / SWERVE.SECONDS_FROM_STAGE_TO_CHAIN, 0, SWERVE.SECONDS_FROM_STAGE_TO_CHAIN)
         ),
         ...
         new ParallelCommandGroup(
            new ClimberRotatePastRotations(CLIMBER.ROTATE_PAST_EXTENSION_SPEED, CLIMBER.PAST_EXTENSION_ROTATIONS),
            new DriveAtSpeed(-(SWERVE.DISTANCE_TO_ROTATE_PAST_EXTENSION / SWERVE.SECONDS_TO_ROTATE_PAST_EXTENSION), 0, SWERVE.SECONDS_TO_ROTATE_PAST_EXTENSION)
         ),
