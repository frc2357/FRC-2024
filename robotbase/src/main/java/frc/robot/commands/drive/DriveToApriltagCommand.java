...
public class DriveToApriltagCommand extends Command {
   ...
   public void initialize() {
      ...
      m_canSeePieceDebouncer = new Debouncer(Constants.SWERVE.AUTO_TRANSLATE_DEBOUNCE_SECONDS,
   ...
   public void execute() {
      ...
      Robot.drive.drive(-m_yController.calculate(ty +
            Constants.SWERVE.APRILTAG_TY_MAGIC_OFFSET),
