...
public final class Constants {
  ...
  public static final class CLIMBER {
    ...
    public static final double LEVEL_CLIMB_TOLERANCE = 0.5; // +/- 0.25 degrees

    public static final double ROTATE_PAST_EXTENSION_SPEED = -0.2;
    public static final double NOTE_HANDOFF_MAX_ROTATIONS = 100; // Be generous on this

    public static final double ROTATE_PAST_PREPOSE_SPEED = 0.2;
    public static final double PREPOSE_ROTATIONS = 100; // Be generous on this

    public static final double ROTATE_PAST_TEN_DEGREES_SPEED = 0.2;
    public static final double TEN_DEGREES_ROTATIONS = 100; // Be generous on this
  }
