...
public class CubeBotTunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(9).withKI(0).withKD(0).withKS(3).withKV(0).withKA(0);
  ...
  private static final double kFrontLeftEncoderOffset = 0.078125;
  ...
  private static final double kFrontRightEncoderOffset = 0.478271484375;
  ...
  private static final double kBackRightEncoderOffset = 0.378173828125;
