...
public class CodriverControls implements RumbleInterface {
  ...
  private void mapControls() {
    ...
    // Alliance selection
    // m_rightBumper.onTrue(new InstantCommand(() ->
    // Robot.state.setAlliance(Alliance.Red)));
    // m_leftBumper.onTrue(new InstantCommand(() ->
    // Robot.state.setAlliance(Alliance.Blue)));
    ...
    // Intake - Left DPad
    // leftDPadAndRightTrigger.whileTrue(new
    // IntakeAxis(subsystemRollerForwardAxis));
    ...
    // EndAffectorAxis(subsystemRollerForwardAxis));
    // downDPadAndLeftTrigger.whileTrue(new
    // EndAffectorAxis(subsystemRollerReverseAxis));
