...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // DataLogManager.logNetworkTables(true); // enable/disable automatic
    // NetworksTable Logging
    // DataLogManager.start("", "", 1.0); // defaults, flush to flash every 0.25
    // seconds
  ...
  public void robotPeriodic() {
    ...
    // "Alliance", state.getAlliance() == null ? "None" :
    // state.getAlliance().toString());
